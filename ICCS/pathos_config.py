...
dim_table_list_rb = ['pathos_cl_master_dim_mapping', 'pathos_cl_master_manufacturer', 'pathos_cl_master_brand', 
                  'pathos_cl_master_prod_ver','pathos_cl_master_time', 'pathos_cl_master_product', 'pathos_cl_master_gmo', 
                  'pathos_cl_master_source','pathos_cl_master_channel', 'pathos_cl_master_country', 'pathos_cl_master_personas']

dim_table_list_iccs = ['pathos_cl_master_dim_mapping', 'pathos_cl_master_time','pathos_cl_master_time_new','pathos_cl_master_prod_serv_cf7',
                       'pathos_cl_master_prod_serv_cf8','pathos_cl_master_prod_serv_cf20', 'pathos_cl_master_prod_ver',
                      'pathos_cl_master_channel', 'pathos_cl_master_age', 'pathos_cl_master_gender', 'pathos_cl_master_income',
                      'pathos_cl_master_occupation','pathos_cl_master_education','pathos_cl_master_country', 'pathos_cl_master_personas']
               
# https://docs.google.com/spreadsheets/d/1rEDWFoQgMTtbX569at4yVoqCZ7P1iHhB --rb
# https://docs.google.com/spreadsheets/d/1K60gTPi9osl3mpiZIP7KN5C3mtEvWDH7 --iccs
